...
class ClientDatabase:
    ...
    def __init__(self, name):
        ...
        # Поскольку клиент многопоточный необходимо отключить проверки на подключения с разных потоков,
...
if __name__ == '__main__':
    ...
    # test_db.save_message('test1', 'test2', f'Привет! это тестовое сообщение от {datetime.datetime.now()}!')
    # test_db.save_message('test2', 'test1', f'Привет! а это другое тестовое сообщение от {datetime.datetime.now()}!')
